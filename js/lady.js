...
Lady.rules = {"parser":"(?:(?:<\\?php)|((?:^|\\?>)(?:[^<]|<[^?])*(?=<\\?|$))|(?:\"[^\"\\\\]*(?:\\\\[\\s\\S][^\"\\\\]*)*\"|'[^'\\\\]*(?:\\\\[\\s\\S][^'\\\\]*)*')|(?:\/\/|\\#)[^\\n]*(?=\\n)|\/\\*(?:[^*]|\\*(?!\/))*\\*\/|(?:[a-zA-Z0-9_]\\w*))","closure":"(^|[^>.$]|[^-]>)F[S\\s]*\\(","tokens":{"A":"case|default","D":"[0-9].*","E":"self","F":"function","G":"as","I":"['\"]_*[a-z][a-zA-Z0-9_]*['\"]","J":"and|extends|implements|instanceof|insteadof|x?or","K":"break|continue|end(?:declare|for(?:each)?|if|switch|while)?|false|null|return|true","L":"callable|catch|class|clone|const|declare|do|echo|else(?:if)?|for(?:each)?|global|goto|if|include(?:_once)?|interface|new|print|private|require(?:_once)?|switch|throw|trait|try|var|while|yield|array|binary|bool(?:ean)?|double|float|int(?:eger)?|object|real|string|unset","M":"private|protected|public|final|abstract","O":"namespace|use","P":"<\\?php","R":"parent","S":"[\/\\#][\\w\\W]*","T":"this","U":"static","V":"_*[a-z]\\w*|GLOBALS|_SERVER|_REQUEST|_POST|_GET|_FILES|_ENV|_COOKIE|_SESSION","H":"['\"][\\w\\W]*","C":"_*[A-Z].*"},"dictionary":{"case":"A","class":"[CERU]","eol":"(?:\\n|$)","eos":"[S\\s]*(\\n|$)(?![S\\s]*([\\])\\.\\-+:=\/%*&|>,\\{?GJ]|<[^?]))","function":"F","key":"[AEFGJKLMOPRTUV]","keyword":"[AEFGJKLMOPRU]","leading":"[FGJLO]","methodprefix":"[MU][MSU\\s]*","noesc":"^|[^\\\\]","noprop":"^|[^>$\\\\]|[^-]>","ns":"[O\\\\]","as":"G","phptag":"P","self":"E","space":"[S\\s]","string":"[HI]","this":"T","var":"[TV]"},"toPhp":{"(noesc)@@":"$1self::","(noesc)@":"$1$this->","(ns,space*)var|var(space*\\\\)":"$1C$2","(class,space*as,space*)var":"$1C","(([$.]|->)keyword)":"$2V","(^|[^\\?:S\\s\\\\]):(space)":"$1 =>$2","(^|[,[(]space*)key(\\s?=>)":"$1'I'$2","\\.([^.=D])":"->$1","(class)->":"$1::","(noesc)~":"$1.","(noprop)(var(?!space*\\())":"$1$$2","(string|[A-RT-Z\\]\\)\\-\\+]|[^\\{;S\\s]\\})(eos)":"$1;$2","((?:noprop)leading|P);(space*eol)":"$1$2","(case[^\\n]*)\\s\\=>":"$1:","<\\?(?!p[h][p]\\b|=)":"<?php","(methodprefix)(var,space*\\()":"$1function $2","\\\\([~@$])":"$1"},"toLady":{"([@~])":"\\\\$1","(->|\\$)\\$":"$1\\\\$","(^|[,[(]space*)(\\$var,space*=>)":"$1\\\\$2","\\$this->":"@N","self::":"@@N","\\.(?![=D])":"~","->":".","(class)::":"$1.","(noesc)\\$(var(?!space*\\())":"$1$2","\\$(keyword)":"$V","I(\\s?=>)":"Y$1","(^|[^S\\s])\\s?=>(\\s)":"$1:$2","(phptag)":"N<?","(methodprefix)function(?:space)(space*var)":"$1N$2","\\\\\\$":"$",";(space*eol)":"$1"}};
